...
import MapPage from '../../src/js/map/MapPage'

describe('MapPage', () => {
  it('displays right map', () => {
    let component = shallow(<MapPage params={{place_id: "some-place-id"}} />)
  ...
  it('displays a link to the restaurant detail screen', () => {
    let component = shallow(<MapPage params={{place_id: "some-place-id", restaurant_id: 1}} />)
